...
if __name__ == "__main__":
    ...
    if choice == "image":
        ...
        encrypted_text = [rsa_encrypt(ord(char), public_key) for char in text]
        encrypted_text = ''.join([chr(char) for char in encrypted_text])
        print("Encrypted Text: ", encrypted_text)
        encrypted_text = [ord(char) for char in encrypted_text]
        decrypted_text = ''.join([chr(rsa_decrypt(char, private_key)) for char in encrypted_text])
